...
REQUIRES = [
    ...
    "funcx @ git+https://github.com/funcx-faas/funcX.git@file_trans_dev#egg=funcx&subdirectory=funcx_sdk",  # noqa: E501
    "funcx-endpoint @ git+https://github.com/funcx-faas/funcX.git@file_trans_dev#egg=funcx-endpoint&subdirectory=funcx_endpoint",  # noqa: E501
    "pyzmq==22.0.3",
    "pika==1.2.0",
